...
class XGBoostFeatureSelection(data_preparation.data_preparation.DataPreparation):
    ...
    def process(self, inputs):
        ...
        data_frame = eli5.format_as_dataframe(expl)  # data frame version

        xgb_sorted_features = data_frame['feature'].values.tolist()  # features list

        features_sig = data_frame['weight'].values.tolist()  # significance score weights
